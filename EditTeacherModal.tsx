...
import { X, Camera, Phone, User } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="relative w-20 h-20 rounded-2xl bg-slate-100 border-2 border-dashed border-slate-300 hover:border-slate-400 flex items-center justify-center transition-colors cursor-pointer overflow-hidden"
            >
              {form.photo ? (
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button type="submit"
              className="flex-1 py-2.5 rounded-xl bg-slate-900 text-white font-medium hover:bg-slate-800 transition-colors cursor-pointer">Save</button>
          </div>
        </form>
      </motion.div>
    </motion.div>
